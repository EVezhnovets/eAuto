    ...
    public partial class AddInitialMigrationToDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderCarDataModels", x => x.OrderCarId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EngineIdentificationName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    EngineFuelType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    EngineFuelTypeId = table.Column<int>(type: "int", maxLength: 50, nullable: false),
                    EngineCapacity = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    EnginePower = table.Column<int>(type: "int", maxLength: 50, nullable: true),
                    BrandId = table.Column<int>(type: "int", maxLength: 50, nullable: false),
                    ModelId = table.Column<int>(type: "int", maxLength: 50, nullable: false),
                    GenerationId = table.Column<int>(type: "int", maxLength: 50, nullable: false),
                    BodyTypeId = table.Column<int>(type: "int", maxLength: 50, nullable: false),
