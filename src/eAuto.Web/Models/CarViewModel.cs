...
namespace eAuto.Web.Models
{
    public sealed class CarViewModel
    {
        ...
        [Required]public decimal PriceInitial { get; set; }
        ...
        [Required] public int Odometer { get; set; }
        [Required] public string? Description { get; set; }
		public string? EngineIdentificationName { get; set; }
		public int EngineFuelTypeId { get; set; }
        [Required] public string? EngineFuelType { get; set; }
        [Required] public string? EngineCapacity { get; set; }
